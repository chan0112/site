...
?>
	...
	<form method="post" action="admin_member_update.php?num=<?=$num?>">
		...
		<span class="col8"><button type="buttom" onclick="location.href='admin_member_delete.php?num=<?=$num?>'">삭제</button></span>
	</form>
	</li>
<?php
		$number--;
...
?>
	...
	<form method="post" action="admin_reference_delete.php">
<?php
...
<?php
	...
	mysqli_close($con);
?>
	<button type="submit">선택된 자료 삭제</button>
	</form>
	</ul>
